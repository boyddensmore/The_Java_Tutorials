...
//			  or objects referred to by fields.
// 		2. Make all fields final and private.
// 		3. Don't allow subclasses to override methods. The simplest way 
// 		   to do this is to declare the class as final. A more sophisticated 
